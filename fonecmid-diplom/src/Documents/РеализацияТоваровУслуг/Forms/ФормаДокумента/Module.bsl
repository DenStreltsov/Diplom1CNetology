...
Процедура ВКМ_Заполнить(Команда)
	Если Объект.Договор.ВидДоговора = ОбщегоНазначенияКлиент.ПредопределенныйЭлемент("Перечисления.ВидыДоговоровКонтрагентов.ВКМ_АбонентскоеОбслуживание") Тогда
