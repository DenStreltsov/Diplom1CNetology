...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	//{{Стрельцов Д.А. Создание предустановленных профилей групп доступа
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Кадровик-расчетчик";
	ОписаниеПрофиля.Идентификатор = "736f68f2-eb93-4bd5-8ce8-8b3ac648e437";
	...
	ОписаниеПрофиля.Роли.Добавить("ВКМ_ДобавлениеИзменениеДокументовЗарплаты");
	...
	ОписаниеПрофиля.Идентификатор = "a0979964-96b8-4aff-b126-e993d1a3349b";
	...
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя           = "Менеджер";
	ОписаниеПрофиля.Идентификатор = "01fd2cec-9adf-4b21-8d4d-0372458ea6d9";
	...
	ОписаниеПрофиля.Идентификатор = "b67d2702-86b5-4c46-83ce-1ff4f27f50a2";
